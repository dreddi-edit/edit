...
function getFriendlyImportErrorMessage(error: unknown, source: ImportSourceKind, fallback: (text: string) => string) {
  ...
  if (/payload too large|request entity too large|entity too large|body.+too large|content.+too large/i.test(message)) {
    return source === "upload"
      ? fallback("ZIP upload failed because the package is too large. Try a smaller ZIP or split the upload into a folder/import batch.")
      : fallback("Import failed because the request is too large.")
  }
    ...
    <div className="pd-shell">
      ...
      {showNewProject ? (
        <div className="pd-modal-backdrop" onClick={resetNewProjectForm}>
          <div className="pd-modal pd-modal-compact pd-modal-new-project" onClick={event => event.stopPropagation()}>
            <div className="pd-modal-header">
              <div>
            ...
            <div className="pd-modal-body pd-modal-body-compact">
              <input
                ref={uploadInputRef}
                type="file"
                hidden
                multiple
                accept=".zip,.html,.htm,.svg,.md,.markdown,.txt,.php,.liquid,.twig,.njk,.nunjucks,.hbs,.handlebars,.mustache,.ejs,.erb,.aspx,.jsp,.pdf,.docx,.xml,.json,.css,.js,image/*"
                      ...
                      <section className="pd-import-source-card is-active">
                        <div className="pd-import-source-head">
                          ...
                          <div>
                            ...
                            <span>{rt("HTML, ZIP, PDF, DOCX, screenshots, and folders.")}</span>
                          </div>
                        </div>
                        <div className={`pd-import-dropzone-wrap${newImporting ? " is-loading" : ""}`}>
                          ...
                          >
                            ...
                            <span>{rt("Drop one ZIP or a folder, or pick files manually. The importer detects pages, assets, and support files automatically.")}</span>
                            ...
                            <div className="pd-import-drop-hints">
                              ...
                              <span>HTML</span>
                              <span>PDF/DOCX</span>
                              <span>{rt("Screenshots")}</span>
                              <span>{rt("Folders")}</span>
                            </div>
                          </div>
                        </div>
                      </section>
